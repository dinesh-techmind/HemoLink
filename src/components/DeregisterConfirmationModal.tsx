  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
      ...
      >
          ...
          <>
            ...
            <div className="p-6 overflow-y-auto space-y-6 text-xs text-text-muted">
                  ...
                  <div className="space-y-2 pt-1">
                    ...
                    <div className="space-y-2 max-h-40 overflow-y-auto pr-1">
                      {associatedEmergencies.slice(0, 3).map((req) => (
                        <div
                          key={req.requestId}
                          className="p-2.5 bg-black/40 border border-red-500/30 rounded-xl flex items-center justify-between gap-3 text-xs"
                        >
              ...
              <div className="p-4 bg-surface-dark border border-border-dark rounded-2xl flex items-center justify-between gap-4">
                ...
                <span className="text-[10px] font-mono uppercase px-2.5 py-1 rounded-lg font-bold bg-zinc-800 text-zinc-400 border border-zinc-700">
                  Active Record
                </span>
              </div>
              ...
              <div
                ...
                className={`p-3.5 rounded-2xl border transition-all cursor-pointer flex items-center gap-3 select-none ${
                  acknowledged
                    ...
                    : "bg-surface-dark border-border-dark text-text-muted hover:border-zinc-600"
                }`}
              >
              ...
              >
                <div className="flex items-center justify-center gap-2 text-red-400 font-bold">
                  ...
                  <h4 id="deregister-confirm-prompt-title" className="text-sm sm:text-base font-extrabold text-white font-display">
            ...
            <div className="p-6 bg-surface-dark/90 border-t border-border-dark flex flex-col sm:flex-row items-center justify-between gap-3">
              <button
                ...
                type="button"
                onClick={onClose}
                className="w-full sm:w-auto px-5 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-text-bright rounded-xl text-xs font-bold transition cursor-pointer border border-border-dark"
              >
                No, Keep My Profile
              </button>
        ...
        {step === "feedback" && (
          <div id="deregister-feedback-survey-step" className="flex flex-col flex-1">
            {/* Header */}
            ...
            <div className="p-6 overflow-y-auto space-y-5 text-xs text-text-muted">
                      ...
                      <button
                        ...
                        className={`w-full p-3 rounded-xl border text-left transition flex items-center justify-between gap-3 cursor-pointer ${
                          isSelected
                            ...
                            : "bg-surface-dark border-border-dark text-text-muted hover:border-zinc-600 hover:text-text-bright"
                        }`}
                      >
              ...
              <div className="space-y-1.5 pt-1">
                ...
                <textarea
                  ...
                  className="w-full p-3 rounded-xl bg-surface-dark border border-border-dark text-text-bright placeholder:text-zinc-600 focus:outline-none focus:border-amber-500/60 transition resize-none text-xs"
                />
              </div>

              {/* Gratitude note */}
              <div className="p-3 bg-surface-dark/60 border border-border-dark rounded-xl flex items-center gap-2.5 text-[11px] text-zinc-400">
            ...
            <div className="p-6 bg-surface-dark/90 border-t border-border-dark flex flex-col sm:flex-row items-center justify-between gap-3">
              <button
                ...
                className="w-full sm:w-auto px-4 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-text-bright rounded-xl text-xs font-bold transition cursor-pointer border border-border-dark flex items-center justify-center gap-1.5"
              >
              ...
              <div className="flex flex-col sm:flex-row items-center gap-2 w-full sm:w-auto">
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2.5 bg-zinc-800 hover:bg-zinc-700 text-zinc-400 hover:text-text-bright rounded-xl text-xs font-semibold transition cursor-pointer border border-border-dark"
                >
